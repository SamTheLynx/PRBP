        ...
        <div className="text-center md:text-left md:w-1/2 p-8">
          ...
          <div className="flex flex-col gap-6 items-center md:items-start">
            <Link to="/admin-login" className="card-link">
              <div className="card bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 bg-gradient-to-r from-gray-200 via-blue-100 to-blue-200">
